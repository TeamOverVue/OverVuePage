...
// EXTERNAL MODULE: ./node_modules/@emotion/is-prop-valid/dist/is-prop-valid.esm.js + 1 modules
var is_prop_valid_esm = __webpack_require__(6682);
...
// 
var styled_components_esm_isPlainObject = (function (x) {
...
// 
function styled_components_esm_isFunction(test) {
...
var wrapAsElement = function wrapAsElement(css, names) {
  return function () {
    ...
    return index_js_default().createElement('style', _extends({}, props, { dangerouslySetInnerHTML: { __html: css() } }));
  };
};
...
var StyleSheet = function () {
  ...
  StyleSheet.prototype.toReactElements = function toReactElements() {
    ...
    return this.tags.map(function (tag, i) {
      var key = 'sc-' + id + '-' + i;
      return (0,index_js_.cloneElement)(tag.toElement(), { key: key });
    });
  };
...
var objToCssArray = function objToCssArray(obj, prevKey) {
  ...
  keys.forEach(function (key) {
    if (!isFalsish(obj[key])) {
      if (styled_components_esm_isPlainObject(obj[key])) {
        rules.push.apply(rules, objToCssArray(obj[key], key));

        return rules;
      } else if (styled_components_esm_isFunction(obj[key])) {
...
function flatten(chunk, executionContext, styleSheet) {
  ...
  if (styled_components_esm_isFunction(chunk)) {
  ...
  /* Handle objects */
  return styled_components_esm_isPlainObject(chunk) ? objToCssArray(chunk) : chunk.toString();
}
...
function css(styles) {
  ...
  if (styled_components_esm_isFunction(styles) || styled_components_esm_isPlainObject(styles)) {
    // $FlowFixMe
...
function hasFunctionObjectKey(obj) {
  ...
  for (var key in obj) {
    if (styled_components_esm_isFunction(obj[key])) {
      return true;
    }
  }
...
function isStaticRules(rules, attrs) {
  for (var i = 0; i < rules.length; i += 1) {
    ...
    if (Array.isArray(rule) && !isStaticRules(rule, attrs)) {
      return false;
    } else if (styled_components_esm_isFunction(rule) && !isStyledComponent(rule)) {
  ...
  if (attrs.some(function (x) {
    return styled_components_esm_isFunction(x) || hasFunctionObjectKey(x);
  })) return false;
 ...
 */
function styled_components_esm_escape(str) {
  return str
...
var ThemeContext = (0,index_js_.createContext)();
...
var ThemeProvider = function (_Component) {
  ...
  ThemeProvider.prototype.getTheme = function getTheme(theme, outerTheme) {
    if (styled_components_esm_isFunction(theme)) {
...
var ServerStyleSheet = function () {
  ...
  ServerStyleSheet.prototype.interleaveWithNodeStream = function interleaveWithNodeStream(readableStream) {
    ...
    var transformer = new (external_stream_default()).Transform({
...
var StyleSheetContext = (0,index_js_.createContext)();
...
function generateId(_ComponentStyle, _displayName, parentComponentId) {
  var displayName = typeof _displayName !== 'string' ? 'sc' : styled_components_esm_escape(_displayName);
...
var StyledComponent = function (_Component) {
  ...
  StyledComponent.prototype.renderInner = function renderInner(theme) {
    ...
    for (key in computedProps) {
      ...
      if (key === 'forwardedComponent' || key === 'as') {
        continue;
      } else if (key === 'forwardedRef') propsForElement.ref = computedProps[key];else if (key === 'forwardedAs') propsForElement.as = computedProps[key];else if (!isTargetTag || (0,is_prop_valid_esm/* default */.Z)(key)) {
  ...
  StyledComponent.prototype.buildExecutionContext = function buildExecutionContext(theme, props, attrs) {
    ...
    attrs.forEach(function (attrDef) {
      ...
      if (styled_components_esm_isFunction(resolvedAttrDef)) {
        // $FlowFixMe
      ...
      for (key in resolvedAttrDef) {
        ...
        if (!attrDefWasFn) {
          if (styled_components_esm_isFunction(attr) && !isDerivedReactComponent(attr) && !isStyledComponent(attr)) {
            if (false) {}
...
function createStyledComponent(target, options, rules) {
  ...
  var styledComponentId = options.displayName && options.componentId ? styled_components_esm_escape(options.displayName) + '-' + options.componentId : options.componentId || componentId;
  ...
  var forwardRef = function forwardRef(props, ref) {
    return index_js_default().createElement(ParentComponent, _extends({}, props, { forwardedComponent: WrappedStyledComponent, forwardedRef: ref }));
  };
  ...
  WrappedStyledComponent.withComponent = function withComponent(tag) {
    ...
    var newComponentId = previousComponentId && previousComponentId + '-' + (isTag(tag) ? tag : styled_components_esm_escape(getComponentName(tag)));
...
/* harmony default export */ const styled_components_esm = (styled);

//# sourceMappingURL=styled-components.esm.js.map

;// CONCATENATED MODULE: ./src/styles/HeadTwoStyle.js
// styled component for <h2> header
// Heading of body
const HeadTwoStyles=styled_components_esm.div`
  margin: 1em;
...
`;/* harmony default export */ const HeadTwoStyle = (HeadTwoStyles);
;// CONCATENATED MODULE: ./src/containers/Body.js
const Body=()=>{return/*#__PURE__*/index_js_default().createElement("div",{className:"margin-tb-small"},/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Create Components"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"Quickly start your project by creating and naming your first component. Interact with it in the CSS Container."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Add html element Gif",className:"shadow",src:"https://media.giphy.com/media/MHqQTb5Vdtewlra4pG/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Add and change HTML Elements"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"Add HTML elements inside your component. You can now modify the specifications of your prototype."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Add html element Gif",className:"shadow",src:"https://media.giphy.com/media/YyPpNuH86r25JZNd46/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Add attributes to components "),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"Add a class and/or an ID attribute to the component to tailor it to your needs."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Add component attribute Gif",className:"shadow",src:"https://media.giphy.com/media/3eKBo9Qfi16mVdGIz4/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Add Notes"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"You can add personalized messages to help you keep track of your components."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Notes Gif",className:"shadow",src:"https://media.giphy.com/media/1ttTOYNOTYBSOoWtG1/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Add Two-Way Binding or other Attributes"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"Options to add attributes to add specific functionality such as two way binding and class is now available."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Add html element attribute Gif",className:"shadow",src:"https://media.giphy.com/media/aXMkIStyTE0jkNlRtO/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Style HTML Elements"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"Stylize HTML elements to visualize your product. Adjustable style options to include height, width, color, and size."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Style html elements Gif",className:"shadow",src:"https://media.giphy.com/media/Q0DYBMnuMLXoo5buvW/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Child Components"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"Child components can be easily incorporated into the code snippet. Child components will be available to be added from the HTML element list."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Gif of adding child components",className:"shadow",src:"https://media.giphy.com/media/3j42CzkMDEpEFFbJZT/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Visualize Prototype"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"Note the project's high level overview by visiting the Project Tree tab to observe the component\u2019s hierarchy."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Gif of visualizing the prototype project tree",className:"shadow",src:"https://media.giphy.com/media/vncIbdxJ36uU7a1bk3/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Code Snippet"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"The boilerplate code is visible at every step of prototyping and dynamically updates according to new edits."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Gif of live rendering of code snippet",className:"shadow",src:"https://media.giphy.com/media/JLCUOmKfQpOmdWUf4l/giphy.gif"}))),/*#__PURE__*/index_js_default().createElement(Section,null,/*#__PURE__*/index_js_default().createElement("div",{className:"left"},/*#__PURE__*/index_js_default().createElement(HeadTwoStyle,null,/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("h1",null,"Export boilerplate"),/*#__PURE__*/index_js_default().createElement("p",{className:"p"},"Export the prototype's code in a lightweight boilerplate and develop the product further in an IDE."))),/*#__PURE__*/index_js_default().createElement("img",{alt:"Gif of exporting the prototype's boilerplate",className:"shadow",src:"https://media.giphy.com/media/v8IbYTVrgFboHgpxBB/giphy.gif"}))));};const Section=styled_components_esm.div`
  /* mobile */
  display: flex;
  margin: 4rem 12rem;
  align-items: flex-start;
...
`;
;// CONCATENATED MODULE: ./src/styles/DeveloperCard.js
// styling for the developer card in footer
const DeveloperCard_DeveloperCard=styled_components_esm.div`
  display: flex;
  flex-direction: column;
  justify-content: space-around;
  align-items: center;
...
`;/* harmony default export */ const styles_DeveloperCard = ((/* unused pure expression or super */ null && (DeveloperCard_DeveloperCard)));
;// CONCATENATED MODULE: ./src/components/Contribute.js
// styling and functionality of writing, OverVue link below the developer card
const BottomDiv=styled_components_esm.div`
...
`;const Contribute_Contribute=()=>{return/*#__PURE__*/React.createElement(BottomDiv,null,/*#__PURE__*/React.createElement("h2",null,"Want to Contribute?"),/*#__PURE__*/React.createElement("div",null,"OverVue is open source. Help make Vue prototyping better!"),/*#__PURE__*/React.createElement("a",{className:"contribute",href:"https://github.com/open-source-labs/OverVue"},/*#__PURE__*/React.createElement("p",null,"Github ")," ",/*#__PURE__*/React.createElement("i",{className:"fab fa-github"})));};
;// CONCATENATED MODULE: ./src/assets/dev-pics/ari.jpg
/* harmony default export */ const dev_pics_ari = (__webpack_require__.p + "static/ari-57559d165e4cba73f133d62baab9efc0.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/aram.jpg
/* harmony default export */ const dev_pics_aram = (__webpack_require__.p + "static/aram-134471c0eec5dbae27591e16e89a0e55.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/dean-chung.png
/* harmony default export */ const dean_chung = (__webpack_require__.p + "static/dean-chung-c509e0731a54883677d133809df03f6d.png");
;// CONCATENATED MODULE: ./src/assets/dev-pics/deano.jpg
/* harmony default export */ const dev_pics_deano = (__webpack_require__.p + "static/deano-81513e35ca1141201c1caea97839c736.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/drew.jpg
/* harmony default export */ const dev_pics_drew = (__webpack_require__.p + "static/drew-446f4f19325a88a566c853eb2b1ed656.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/joseph.jpg
/* harmony default export */ const dev_pics_joseph = (__webpack_require__.p + "static/joseph-bc19ebec7535621222f07a87d0ee0af8.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/alex.png
/* harmony default export */ const dev_pics_alex = (__webpack_require__.p + "static/alex-e7d8ec0220dbd842e81fb0f848d72ef5.png");
;// CONCATENATED MODULE: ./src/assets/dev-pics/joju.jpg
/* harmony default export */ const dev_pics_joju = (__webpack_require__.p + "static/joju-36882e065b2883c7fcae4195c1796fcc.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/keri_overvue.png
/* harmony default export */ const keri_overvue = (__webpack_require__.p + "static/keri_overvue-6d36c8d7c7fa7df57c4d82e8f752cb7a.png");
;// CONCATENATED MODULE: ./src/assets/dev-pics/allison1.jpg
/* harmony default export */ const allison1 = (__webpack_require__.p + "static/allison1-66635022a393f9ee5b40b6672a516a32.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/FarazPic.png
/* harmony default export */ const FarazPic = (__webpack_require__.p + "static/FarazPic-f4defca1092746232255585e050d55f8.png");
;// CONCATENATED MODULE: ./src/assets/dev-pics/SeanPic.png
/* harmony default export */ const SeanPic = (__webpack_require__.p + "static/SeanPic-61e2739c4f430daa92b73e02330cc22e.png");
;// CONCATENATED MODULE: ./src/assets/dev-pics/NicholasPic.jpeg
/* harmony default export */ const NicholasPic = (__webpack_require__.p + "static/NicholasPic-9c7a73c06653d3371dd7957f08bd9694.jpeg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/TerryPic.jpg
/* harmony default export */ const TerryPic = (__webpack_require__.p + "static/TerryPic-d96ec57005f76850e5ea251f69f0e31f.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/alexlu.jpg
/* harmony default export */ const dev_pics_alexlu = (__webpack_require__.p + "static/alexlu-f7006f2965fa85467985b9e716488d1b.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/jeffrey.jpeg
/* harmony default export */ const dev_pics_jeffrey = (__webpack_require__.p + "static/jeffrey-e343ecfe2140ae08b477263f3487d2cc.jpeg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/kenny.jpg
/* harmony default export */ const dev_pics_kenny = (__webpack_require__.p + "static/kenny-ab9e26c0b935797e122d5b009415844d.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/bender.jpeg
/* harmony default export */ const dev_pics_bender = (__webpack_require__.p + "static/bender-ad9fe3e72a4e0efa079b34e93b7af888.jpeg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/sonny.jpg
/* harmony default export */ const dev_pics_sonny = (__webpack_require__.p + "static/sonny-d63fa843e81abf6b78e38752a6245a8f.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/ross.jpg
/* harmony default export */ const dev_pics_ross = (__webpack_require__.p + "static/ross-f6e3c0141168f4f2f190b437e32ba870.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/gabby.jpg
/* harmony default export */ const dev_pics_gabby = (__webpack_require__.p + "static/gabby-d63d202e91db97d93587053f0cef4d12.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/shanon.jpeg
/* harmony default export */ const dev_pics_shanon = (__webpack_require__.p + "static/shanon-87a7f573991b97c848d54f1fadf21b79.jpeg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/zoew.png
/* harmony default export */ const dev_pics_zoew = (__webpack_require__.p + "static/zoew-55698b82334ae17899b02ae9dc7f01f7.png");
;// CONCATENATED MODULE: ./src/assets/dev-pics/julia.jpeg
/* harmony default export */ const dev_pics_julia = (__webpack_require__.p + "static/julia-e96cabc3df01f0458f04613cd9d81d3d.jpeg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/kerolos.jpg
/* harmony default export */ const dev_pics_kerolos = (__webpack_require__.p + "static/kerolos-f52e1f7cd14f94cde0483a4ccf5d1fb1.jpg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/bryanb.png
/* harmony default export */ const dev_pics_bryanb = (__webpack_require__.p + "static/bryanb-771312bb1e10f6961cc894ec9a2cda64.png");
;// CONCATENATED MODULE: ./src/assets/dev-pics/keyla.jpeg
/* harmony default export */ const dev_pics_keyla = (__webpack_require__.p + "static/keyla-89689f5f640513f45324b3e0340437d2.jpeg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/johnny.jpeg
/* harmony default export */ const dev_pics_johnny = (__webpack_require__.p + "static/johnny-94dc9be812814f2cbc212421dd07b646.jpeg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/jace.jpeg
/* harmony default export */ const dev_pics_jace = (__webpack_require__.p + "static/jace-de54c38318fe0d71ed2bec081ff1069d.jpeg");
;// CONCATENATED MODULE: ./src/assets/dev-pics/katherine.png
/* harmony default export */ const dev_pics_katherine = (__webpack_require__.p + "static/katherine-dec76a184191f4195f32875a0875d967.png");
;// CONCATENATED MODULE: ./src/containers/Footer.js
/** functionality for loading developer cards components, and the contribute components **/const Footer=()=>/*#__PURE__*/React.createElement("div",{className:"footer"},/*#__PURE__*/React.createElement("h3",{className:"team-heading"},"Meet the team"),/*#__PURE__*/React.createElement("div",{className:"devCards"},/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:deano,alt:"deano",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Dean Ohashi"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/dnohashi"},"@dnohashi")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:deanfchung,alt:"deanf",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Dean Chung"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/deanfchung"},"@deanfchung")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:drew,alt:"drew",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Drew Nguyen"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/drewngyen"},"@drewngyen")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:joseph,alt:"joseph",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Joseph Eisele"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/jeisele2"},"@jeisele")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:alex,alt:"alex",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Alexander Havas"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/LOLDragoon"},"@LOLDragoon")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:keriann,alt:"keriann",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Keriann Lin"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/keliphan"},"@keliphan")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:joju,alt:"joju",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Joju Olaode"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/JojuOlaode"},"@JojuOlaode")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:allison,alt:"allison",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Allison Pratt"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/allisons11"},"@allisons11")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:faraz,alt:"faraz",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Faraz Moallemi"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/farazmoallemi"},"@farazmoallemi")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:sean,alt:"sean",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Sean Grace"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/ziggrace"},"@ziggrace")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:terry,alt:"terry",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Terry L. Tilley"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/codeByCandlelight"},"@codeByCandlelight")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:nicholas,alt:"nicholas",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Nicholas Schillaci"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/Schillaci767"},"@Schillaci767")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:alexlu,alt:"alexlu",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Alex Lu"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/aleckslu"},"@aleckslu")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:jeffrey,alt:"jeffrey",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Jeffrey Sul"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/jeffreysul"},"@jeffreysul")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:kenny,alt:"kenny",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Kenneth Lee"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/kennyea"},"@kennyea")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:bender,alt:"bender",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Ryan Bender"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/rdbender"},"@rdbender")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:sonny,alt:"sonny",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Sonny Nguyen"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/sn163"},"@sn163")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:shanon,alt:"shanon",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Shanon Lee"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/shanon98lee"},"@shanon98lee")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:ross,alt:"ross",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Ross Lamerson"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/lamerson28"},"@lamerson28")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:gabby,alt:"gabby",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Gabriella Kokhabi"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/gkokhabi"},"@gkokhabi")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:zoew,alt:"zoew",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Zoew McGrath"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/Z-McGrath"},"@Z-McGrath")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:aram,alt:"aram",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Aram Paparian"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/apaparian"},"@apaparian")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:bryanb,alt:"bryan",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Bryan Bart"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/MrBeeAreWhy"},"@MrBeeAreWhy")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:julia,alt:"julia",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Julia Bakerink"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/jbbake"},"@jbbake")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:megan,alt:"megan",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Megan Nadkarni"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/megatera"},"@megatera")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:kerolos,alt:"kerolos",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Kerolos Nesem"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/Kerolos-Nesem"},"@Kerolos-Nesem")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:keyla,alt:"keyla",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Keyla Koizumi Nishimura"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/keylakoizumin"},"@keylakoizumin")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:johnny,alt:"johnny",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Johnny Chan"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/jchan444"},"@jchan444")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:jace,alt:"jace",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Jace Crowe"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/JaceCrowe"},"@JaceCrowe")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:katherine,alt:"katherine",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Katherine Kim"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/katherinek123"},"@katherinek123")),/*#__PURE__*/React.createElement(DeveloperCard,null,/*#__PURE__*/React.createElement("img",{src:ari,alt:"ari",className:"dev-pic"}),/*#__PURE__*/React.createElement("p",{className:"dev-name"},"Ari the Cat"),/*#__PURE__*/React.createElement("a",{href:"https://github.com/MrBeeAreWhy"},"@DatAriLyfe"))),/*#__PURE__*/React.createElement(Contribute,null));
;// CONCATENATED MODULE: ./src/styles/Button.js
const Button=styled_components_esm.a`
  font-size: 1.1rem;
  padding: 10px;
  color: white;
 ...
 * @internal
 */
var LayoutGroupContext = (0,index_js_.createContext)(null);
...
function useLayoutId(_a) {
    ...
    var layoutGroupId = (0,index_js_.useContext)(LayoutGroupContext);
...
function useCreateMotionContext(props, isStatic) {
    ...
    return (0,index_js_.useMemo)(function () { return ({ initial: initial, animate: animate }); }, 
    /**
...
function motion_createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
        ...
        return (index_js_.createElement(index_js_.Fragment, null,
            index_js_.createElement(MotionContext.Provider, { value: context }, useRender(Component, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic)),
            features));
    }
...
var createUnitType = function (unit) { return ({
    test: function (v) {
        return utils_isString(v) && v.endsWith(unit) && v.split(' ').length === 1;
    },
    parse: parseFloat,
...
var alpha = tslib_es6_assign(tslib_es6_assign({}, number), { transform: clamp(0, 1) });
var scale = tslib_es6_assign(tslib_es6_assign({}, number), { default: 1 });
 ...
 */
try {
    var emotionIsPropValid_1 = (__webpack_require__(6682)/* ["default"] */ .Z);
...
var rgbUnit = tslib_es6_assign(tslib_es6_assign({}, number), { transform: function (v) { return Math.round(clampRgbUnit(v)); } });
var rgba = {
...
var mixArray = function (from, to) {
    var output = node_modules_tslib_tslib_es6_spreadArray([], from);
...
function inertia(_a) {
    ...
    function startAnimation(options) {
        ...
        currentAnimation = animate(tslib_tslib_es6_assign(tslib_tslib_es6_assign({}, options), { driver: driver, onUpdate: function (v) {
                var _a;
...
function useDrag(props) {
    ...
    (0,index_js_.useEffect)(function () { return groupDragControls && groupDragControls.subscribe(dragControls); }, [dragControls]);
    // Mount the drag controls with the visualElement
    (0,index_js_.useEffect)(function () { return dragControls.mount(visualElement); }, []);
}
...
function AnimateLayoutContextProvider(props) {
    ...
    return index_js_.createElement(Animate, __assign({}, props, { safeToRemove: safeToRemove }));
}
...
var SharedLayoutContext = (0,index_js_.createContext)(createBatcher());
/**
 * @internal
 */
var FramerTreeLayoutContext = (0,index_js_.createContext)(createBatcher());
...
function MeasureContextProvider(props) {
    var syncLayout = (0,index_js_.useContext)(SharedLayoutContext);
    var framerSyncLayout = (0,index_js_.useContext)(FramerTreeLayoutContext);
    return (index_js_default().createElement(Measure, __assign({}, props, { syncLayout: syncLayout, framerSyncLayout: framerSyncLayout })));
}
...
;// CONCATENATED MODULE: ./src/assets/logo/overvue_trans.png
/* harmony default export */ const overvue_trans = (__webpack_require__.p + "static/overvue_trans-63423075735fcdf2cfc39e1c0684e126.png");
;// CONCATENATED MODULE: ./src/containers/Hero.js
const variants={hidden:{opacity:0},visible:{opacity:1}};const Hero_button={hidden:{y:20,opacity:0},visible:{y:0,opacity:1}};/** Downloads application for windows and mac
    main title and delay of words appearing  **/const Hero=()=>/*#__PURE__*/index_js_default().createElement(HeaderStyles,null,/*#__PURE__*/index_js_default().createElement("div",{className:"title"},/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement("img",{alt:"OverVue logo",id:"mainLogo",src:overvue_trans}))),/*#__PURE__*/index_js_default().createElement(motion.p,{initial:"hidden",animate:"visible",variants:variants,transition:{delay:1},className:"subtitle"},"Prototype driven development"),/*#__PURE__*/index_js_default().createElement(motion.div,{initial:"hidden",animate:"visible",variants:Hero_button,transition:{delay:2,x:{type:"inertia",stiffness:50},default:{duration:1}}},/*#__PURE__*/index_js_default().createElement("div",{className:"title"},/*#__PURE__*/index_js_default().createElement("p",null,"Version 7.0 Now Available")),/*#__PURE__*/index_js_default().createElement(Button,{className:"button",href:"https://github.com/open-source-labs/OverVue/releases/download/v7.0.0/OverVue-Linuxv-7.0.0.dmg"},/*#__PURE__*/index_js_default().createElement("div",{id:"download"},/*#__PURE__*/index_js_default().createElement("div",null,"Download for")," ",/*#__PURE__*/index_js_default().createElement("i",{className:"fab fa-apple"}))),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(Button,{className:"button",href:"https://github.com/open-source-labs/OverVue/releases/download/v7.0.0/OverVue-Windows-v7.0.0.zip"},/*#__PURE__*/index_js_default().createElement("div",{id:"download"},/*#__PURE__*/index_js_default().createElement("div",null,"Download for")," ",/*#__PURE__*/index_js_default().createElement("i",{className:"fab fa-windows"})))));const HeaderStyles=styled_components_esm.div`
  display: flex;
  flex-direction: column;
  height: 98vh;
...
function Homepage(){return/*#__PURE__*/index_js_default().createElement("div",{id:"App"},/*#__PURE__*/index_js_default().createElement(Navbar/* Navbar */.w,null),/*#__PURE__*/index_js_default().createElement(Hero,null),/*#__PURE__*/index_js_default().createElement(Body,null));}
